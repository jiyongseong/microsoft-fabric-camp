...
## [Power BI의 Copilot 기능 Hands-on](copilot-pbi-create-report.md)

* [자연어로 손쉽게 보고서 생성하기](copilot-pbi-create-report.md#자연어로-보고서-생성하기)
* [Copilot으로 보고서 요약 및 내러티브 받아보기](copilot-pbi-create-report.md#자연어로-보고서-생성하기)
* 그 외 알아두면 좋은 Copilot 기능들
